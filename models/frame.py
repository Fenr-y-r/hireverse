...
class Frame:
    ...
    def get_largest_face(self):
        ...
        """
        self.faces = Frame.face_mesh.process(
        ...
        if self.faces:
            ...
            for face in self.faces:
                ...
                if area > max_area:
                    max_area = area
                    largest_face_landmarks = face

            return largest_face_landmarks

        return None

    def set_face_and_facial_landmarks(self):
        largest_face = self.get_largest_face()
        self.face = largest_face
        self.facial_landmarks = largest_face.landmark
    ...
    def get_head_pose_using_mediapipe(self, image, isWebcam=False):
        ...
        results = Frame.face_mesh.process(image)  # pass to model
